...
assert_output_not_contains "no shared-module-shell false positive" "\[FAIL\].*imports/shared-module-shell"
assert_output_not_contains "no R-SEC-21 false positive" "\[FAIL\].*R-SEC-21"
assert_output_not_contains "no R-SEC-22 false positive" "\[FAIL\].*R-SEC-22"
assert_output_not_contains "no R-QUAL-30 false positive" "\[WARN\].*R-QUAL-30"
assert_output_not_contains "no R-QUAL-31 false positive" "\[WARN\].*R-QUAL-31"
assert_output_not_contains "no R-QUAL-32 false positive" "\[WARN\].*R-QUAL-32"
assert_output_not_contains "no R-SEC-23 false positive" "\[WARN\].*R-SEC-23"
assert_output_not_contains "no obfuscated-names false positive" "\[FAIL\].*quality/obfuscated-names"
assert_output_not_contains "no mixed-indentation false positive" "\[WARN\].*quality/mixed-indentation"
assert_output_not_contains "no widget-destroy false positive" "\[WARN\].*lifecycle/widget-destroy"
